...
export const shouldPlayAudio = (message, conversationId, userId, isDocHidden) => {
    const {
    ...
    const playAudio = !isFromCurrentUser && (messageType === MESSAGE_TYPE.INCOMING || isPrivate);
...
export const newMessageNotification = data => {
    ...
    const playAudio = shouldPlayAudio(data, currentConvId, currentUserId, isDocHidden);
    const isNotificationEnabled = notificationEnabled(enableAudioAlerts, currentUserId, assigneeId);
